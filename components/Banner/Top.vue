<template>
  <div
    :class="
      active === 'drive' ? 'bg-drive' : active === 'eat' ? 'bg-eat' : 'bg-ride'
    "
    class="p-0 lg:px-16 lg:py-20 bg-cover"
  >
    <div
      class="
        w-full
    ...
    >
      ...
      >
        ...
        <p class="hover:opacity-70 text-center">Drive or Deliver</p>
      </div>
      <div
        @click="active = 'eat'"
        :class="active === 'eat' ? 'border-b-4' : ''"
        class="banner_item"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="hover:opacity-70 text-center">Eat</p>
      </div>
      <div
        @click="active = 'ride'"
        :class="active === 'ride' ? 'border-b-4' : ''"
        class="banner_item"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="hover:opacity-70 text-center">Ride</p>
      </div>
    </div>
    <div class="grid grid-cols-2">
      ...
      >
        <!-- banner item drive -->
        <content-drive v-if="active === 'drive'"/>
        <!-- banner item eat -->
        <content-eat v-else-if="active === 'eat'"/>
      ...
      <div
        :class="
          active === 'drive'
            ...
            : 'bg-ride'
        "
        class="inline-flex col-span-2 lg:hidden h-64 bg-cover"
      ></div>
    </div>
  </div>
</template>
